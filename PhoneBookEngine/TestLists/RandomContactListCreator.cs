...
namespace PhoneBookEngine
{
    ...
    /// </summary>
    public class RandomContactListCreator
    {
        // Members
        ...
        /// Input list 
        /// </summary>
        private readonly List<Person> myNames = new List<Person>();
        ...
        public List<Person> CreateContactList(int count)
        {
